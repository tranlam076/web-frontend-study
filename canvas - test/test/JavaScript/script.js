(function(){
	...
	function init(){
		...
		{x:500,y:300,r:10,color:125,vx:2,vy:-8},
		{x:800,y:350,r:14,color:285,vx:20,vy:-20},
		{x:800,y:700,r:24,color:325,vx:13,vy:-8},
		{x:400,y:500,r:20,color:175,vx:-4,vy:-6}
		];
		...
		function addCircle(event){
			for (var i=0; i<10; i++) {
				...
				circles.push(circle);
				console.log('now are ' + circles.length + ' - circles total');
